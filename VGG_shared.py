...
# ===============================================================
train_img_dir = os.path.join(path, "/scratch/data/m24cps008/CV_Project/4/images/train/")
val_img_dir = os.path.join(path, "/scratch/data/m24cps008/CV_Project/4/images/val/")
train_label_dir = os.path.join(path, "/scratch/data/m24cps008/CV_Project/4/images/train/")
val_label_dir = os.path.join(path, "/scratch/data/m24cps008/CV_Project/4/labels/val/")
...
def get_model(num_classes):
    backbone = torchvision.models.vgg16_bn(weights='IMAGENET1K_V1').features
    backbone.out_channels = 512

    # ---- FIX: anchor generator for ONE feature map ----
    anchor_generator = AnchorGenerator(
        sizes=((32, 64, 128, 256, 512),),      # one tuple → one feature map
        aspect_ratios=((0.5, 1.0, 2.0),)       # one tuple → one feature map
    )
    ...
    model = FasterRCNN(
        ...
        rpn_anchor_generator=anchor_generator,   # ← required
